...
public class ProdutosTest {
    ...
    public void beforeEach() {
        ...
        // Vou definir um tempo de espera padarao de 5 segundos
    ...
    public void testPossoAdicionarProdutosComValorDeUmCentavo() {
        String mensagemApresentada = new LoginPage(navegador)
                ...
                .submeterFormularioDeLogin()
                .acessarFormularioAdicaoNovoProduto()
                .informarNomeDoProduto("Play Station 4")
    ...
    @Test
    @DisplayName("Posso adicionar produtos que estejam no limite de 7.000")
